"""
kcharted - Billboard Hot 100 히스토리컬 데이터 백필 스크립트
...
SUPABASE_KEY = os.environ.get("SUPABASE_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imhxb292eGl2ZmFibndmZGpudXZzIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NDg2NzI2MiwiZXhwIjoyMDkwNDQzMjYyfQ.CG4MAGpOAeeBH6i8NvgOVi5sgO6PWQfmp_pgztP3_-w")

BB_CHART_NAME = "hot-100"
CHART_SLUG    = "billboard-hot-100"
...
def backfill(start_date: date, end_date: date, delay: float = 3.0, skip_existing: bool = True):
    ...
    print(f"[kcharted] Billboard Hot 100 백필 시작")
    ...
    for i, query_date in enumerate(weeks, 1):
        ...
        for entry in chart:
            try:
                ...
                track_id  = upsert_track(entry.title, artist_id, is_album=False)
...
if __name__ == "__main__":
    ...
    # 예) python3 backfill_hot100_2010_2019.py 2010-01-01 2019-12-31 3
